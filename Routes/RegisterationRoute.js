...
import { getTrialUser, updateTrialUser, getUserData, login, RegisterUser, sendEmail, updateUserData, verifyUser, getAllUsers, getAllPages } from '../Controller/RegisterationController.js';
